...
def xy_diagram(ship, size = 'small'):
    ...
    sail_length = (ship.main_sail.length / ship.hull_length) * length
...
def zx_diagram(ship, size, zx_class):
    ...
    # print('Func: ', static_shape)
    # print(static_shape[1] - zx_class[1])

    cob = ( radius * (-ship.cob[1] / ship.hull_height), hull_offset + radius * (-ship.cob[2] / ship.hull_height) ) 
    cog = ( radius * (-ship.cog[1] / ship.hull_height), hull_offset + radius * (-ship.cog[2] / ship.hull_height) ) 
